...
/**
 * 类描述：图片居中的自定义textview
 *
 * @auther: baoyinbo
 * @date: 2018/9/13 下午12:39
 */

public class TextDrawableCenterView extends android.support.v7.widget.AppCompatTextView {

    public TextDrawableCenterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
