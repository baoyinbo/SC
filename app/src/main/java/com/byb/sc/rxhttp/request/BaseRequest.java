...
package com.byb.sc.rxhttp.request;
...
import com.byb.sc.rxhttp.api.ApiService;
import com.byb.sc.rxhttp.cache.RxCache;
import com.byb.sc.rxhttp.cache.converter.IDiskConverter;
import com.byb.sc.rxhttp.cache.model.CacheMode;
import com.byb.sc.rxhttp.https.HttpsUtils;
import com.byb.sc.rxhttp.interceptor.BaseDynamicInterceptor;
import com.byb.sc.rxhttp.interceptor.CacheInterceptor;
import com.byb.sc.rxhttp.interceptor.CacheInterceptorOffline;
import com.byb.sc.rxhttp.interceptor.HeadersInterceptor;
import com.byb.sc.rxhttp.interceptor.NoCacheInterceptor;
import com.byb.sc.rxhttp.model.HttpHeaders;
import com.byb.sc.rxhttp.model.HttpParams;
import com.byb.sc.rxhttp.utils.HttpLog;
import com.byb.sc.rxhttp.utils.RxUtil;
...
import static com.byb.sc.rxhttp.EasyHttp.getRetrofitBuilder;
import static com.byb.sc.rxhttp.EasyHttp.getRxCache;
